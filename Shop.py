...
class Shop:
    ...
    def total_amount(self, user_name):
        ...
        'Total: ' + str(total), 'After Tax: ' + str(total + tax) , 'Quantity: ' + str(quantity)
        return final_bill
...
print("\n Hello " + user.user_name + " HERE IS THE ITEM WE HAVE AVAILABLE ON THE SHOP")
print(" ___________________________________________________________________________________________")
